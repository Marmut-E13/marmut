    ...
    return (
        <div className={`fixed z-[999] top-0 left-0 w-full h-full flex justify-center items-center ${isOpen ? 'block' : 'hidden'}`} style={{ backgroundColor: 'rgba(0, 0, 0, 0.7)' }}>
            ...
            <div className="flex flex-col items-center">
                    {tipe === "playlist" ? <text className="text-center">Berhasil menambahkan lagu dengan judul {judul} ke dalam {playlist}</text> : <text>Lagu dengan judul {judul} sudah pernah di unduh!</text>}
