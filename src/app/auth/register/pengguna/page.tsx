        ...
        <div className="px-[120px] flex justify-center py-[90px]">
            <form onSubmit={handleRegister} className="min-w-[600px] border-[2px] border-marmut-green-700 rounded-xl p-[55px] flex flex-col gap-4">
                ...
                <div>
                    ...
                    <input name="tempat-lahir"className="form-control border-marmut-green-600" />
                </div>

                <div>
                    <label className="form-label">Tanggal lahir</label>
                    <input name="tanggal-lahir"className="form-control border-marmut-green-600" type="date"/>
                </div>

                <div>
                    <label className="form-label">Kota asal</label>
                    <input name="kota-asal" className="form-control border-marmut-green-600" />
                </div>
                ...
                <div>
                    ...
                    <div className="flex fliex-row justify-between">
                        <div className="flex gap-2">
                            <input className="form-check-input border-marmut-500" name="podcaster-flag" type="checkbox" value="1"/>
                            <label>Podcaster</label>
                        </div>

                        <div className="flex gap-2">
                            <input className="form-check-input border-marmut-500" name="artist-flag" type="checkbox" value="1"/>
                            <label>Artist</label>
                        </div>

                        <div className="flex gap-2">
                            <input className="form-check-input border-marmut-500" name="songwriter-flag" type="checkbox" value="1"/>
