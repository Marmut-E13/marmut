...
<script type="text/javascript" src="https://scele.cs.ui.ac.id/lib/javascript.php/1710690560/lib/javascript-static.js"></script>
<script type="text/javascript">
//<![CDATA[
...
<header id="page-header" class="clearfix">
    ...
    <!-- HEADER: LOGO AREA -->
                    ...
                    <img src="//scele.cs.ui.ac.id/pluginfile.php/1/theme_lambda/logo/1710690560/5.png" class="logo" alt="logo" />                    </a>
                </div>
...
<div id="page" class="container-fluid">
    ...
    <div class="loginpanel">
        ...
        <div class="subcontent loginsub">
                <div class="loginerrors" role="alert">
                    ...
                    <span class="error"><img class="icon icon icon-pre" alt="Error" src="https://scele.cs.ui.ac.id/theme/image.php/lambda/core/1710690560/i/warning" />Your session has timed out. Please log in again.</span>
                </div>
    ...
    <a href="https://scele.cs.ui.ac.id/help.php?component=moodle&amp;identifier=cookiesenabled&amp;lang=en" title="Help with Cookies must be enabled in your browser" aria-haspopup="true" target="_blank"><img class="icon iconhelp" alt="Help with Cookies must be enabled in your browser" title="Help with Cookies must be enabled in your browser" src="https://scele.cs.ui.ac.id/theme/image.php/lambda/core/1710690560/help" />
</a>
</span>
            </div>
...
//<![CDATA[
var require = {
    baseUrl : 'https://scele.cs.ui.ac.id/lib/requirejs.php/1710690560/',
    ...
    paths: {
        jquery: 'https://scele.cs.ui.ac.id/lib/javascript.php/1710690560/lib/jquery/jquery-3.1.0.min',
        jqueryui: 'https://scele.cs.ui.ac.id/lib/javascript.php/1710690560/lib/jquery/ui-1.12.1/jquery-ui.min',
        jqueryprivate: 'https://scele.cs.ui.ac.id/lib/javascript.php/1710690560/lib/requirejs/jquery-private'
    },
...
<script type="text/javascript" src="https://scele.cs.ui.ac.id/lib/javascript.php/1710690560/lib/requirejs/require.min.js"></script>
<script type="text/javascript">
//<![CDATA[
...
require(['jquery'], function($) {
    require(['theme_bootstrapbase/bootstrap'], function() {
        $('#66370ac94855466370ac9433912').popover();
    });
});
;
...
<script type="text/javascript" src="https://scele.cs.ui.ac.id/theme/javascript.php/lambda/1710690560/footer"></script>
<script type="text/javascript">
//<![CDATA[
...
Y.use("moodle-core-dock-loader",function() {M.core.dock.loader.initLoader();
 ...
 M.util.js_pending('random66370ac9433911'); Y.use('block_simple_clock', function(Y) { M.block_simple_clock.initSimpleClock(Y, true, false, true, true, true, 2024, 4, 5, 11, 27, 55);  M.util.js_complete('random66370ac9433911'); });
M.util.help_popups.setup(Y);
Y.use("moodle-core-popuphelp",function() {M.core.init_popuphelp();
});
 M.util.js_pending('random66370ac94339124'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random66370ac94339124'); });
})();
//]]>
</script>
